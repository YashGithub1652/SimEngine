...
public class Simulation extends Application {
    ...
    public void start(Stage SimulationStage) {
        ...
        velocityLabel.setText("Initial Velocity: " + (int) velocitySlider.getValue() + "px");
            velocitySlider.valueProperty().addListener((obs, oldV, newV) ->
            velocityLabel.setText("Initial Velocity: " + newV.intValue() + "px")
        );

        Slider angleSlider = new Slider(100, 400, 273);
        Label AngleLabel = new Label();
        AngleLabel.setStyle("-fx-text-fill : white;"+
                         "-fx-font-weight: Bold;"+
                         "-fx-font-size : 14px");

        AngleLabel.setText("Set Angle: " + (int) angleSlider.getValue() + "px");
            angleSlider.valueProperty().addListener((obs, oldV, newV) ->
            AngleLabel.setText("Set Angle: " + newV.intValue() + "px")
        );
